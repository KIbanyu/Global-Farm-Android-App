 ...
 */
public class DealsProductAdapter extends RecyclerView.Adapter<ProductViewHolder> {
    private ArrayList<ProductModel> products;

    private Context context;


    public DealsProductAdapter(ArrayList<ProductModel> products, Context context) {
