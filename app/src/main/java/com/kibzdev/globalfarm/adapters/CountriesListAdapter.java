...
import com.kibzdev.globalfarm.utils.DeviceUtils;
...
public class CountriesListAdapter extends ArrayAdapter<String> {
    ...
    public View getDropDownView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.imageView = convertView.findViewById(R.id.imgViewFlag);
            viewHolder.textView = convertView.findViewById(R.id.txtViewCountryName);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.textView.setText( getCountryDisplayName(g[1].trim()));
    ...
    public String getCountryDisplayName(String ssid) {
        Locale loc = new Locale("", ssid);
        return loc.getDisplayCountry().trim();
    }

    public String getCountryCode(String ssid) {
        Locale loc = new Locale("", ssid);
