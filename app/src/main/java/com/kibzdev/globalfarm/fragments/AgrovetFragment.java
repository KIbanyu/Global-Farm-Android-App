...
public class AgrovetFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_agrovet, container, false);
    ...
    public void getAgrovets()
    {

        ApiInterface apiInterface = RestAdapter.createAPI();
        Call<GetPostResponse> call = apiInterface.getPosts(Constants.AGROVETS);
